...
import SampleUtility.ExcelUtilityTestNGConcept;

public class testNGDataProviderGetFromExcel
{
	@SuppressWarnings("unused")
	@DataProvider
	public Object[][] getData() throws Throwable
	{
		ExcelUtilityTestNGConcept elib = new ExcelUtilityTestNGConcept();
		int rowCount = elib.getRowCount("AmazonData");
		...
		{
		objArr[i][0]=elib.getDataFromExcel("AmazonData", i+1, 0);
		objArr[i][1]=elib.getDataFromExcel("AmazonData", i+1, 1);
		}
		return objArr;
	}
