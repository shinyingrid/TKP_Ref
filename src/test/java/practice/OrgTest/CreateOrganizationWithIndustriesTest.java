...
public class CreateOrganizationWithIndustriesTest
{
	...
	public void createOrgWithIndTest() throws Throwable, Throwable
	{
		...
		String ExporgName=sheet.getRow(1).getCell(2).toString()+ranNum;
		System.out.println("Org Name generated is : "+ExporgName);
		
		String ExpindName=sheet.getRow(5).getCell(3).toString();
		System.out.println("Industry name to be selected is : "+ExpindName);
		
		String ExptypeName=sheet.getRow(5).getCell(4).toString();
		...
		String ActTypeName = driver.findElement(By.id("dtlview_Type")).getText();
